localStorage.setItem(
  ...
  JSON.stringify([
    {
      message: "Ensure procurement requests across the enterprise are fulfilled rapidly and compliantly — from requisition submission to purchase order issuance — while enforcing vendor governance, architecture standards, and financial controls.",
      response: `  
