// https://sharetext.io/bca2ee3c -v1
// https://sharetext.io/b1db53f8 - v2

localStorage.setItem(
  "demo_2a317976-fdc4-4555-b3b3-120b31d6e7ef",
  JSON.stringify([
    {
...
|-----------|------------------|------------------|-----------|------------------------------------------------------|
| CHAT-552  | Trader T-A       | Desk Head EQD-1  | 10:00:45  | “Keep leaning on the sell side, we can pick it up in a bit and finish.” |
| EMAIL-212 | External contact | Trader T-A       | 09:55:02  | “ACMX order book looks heavy, chance to pick up size cheap.”       |

### Sentiment & Intent Classification
- **Classifier results:** 
    - CHAT-552 → flagged “sell-side pressure / layering tendency” 
    - EMAIL-212 → flagged “tip” language (possible collusion) 
...
**Narrative Draft:**
“Trader T-A placed multiple concentric sell orders at 10:01, followed by a BUY at $4.95 (ACMX). Communications indicate intent to spoof (‘layer those sells… scoop it back’). Market news added pressure, exploited to gain favorable fill. Pattern consistent with probable layering/spoofing under MAR Article 12.” 
