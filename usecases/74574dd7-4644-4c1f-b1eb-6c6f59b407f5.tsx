...
**🤖 Intent & Context Normalization Agent is thinking…**
...
<div
class="max-w-md bg-gray-100"
style="height:166px; width:298px"
>
<img
src="https://i.ibb.co/DDHp74wj/Hero-1.jpg"
alt="Hero Image"
...
>
<img
src="https://i.ibb.co/gYnRVm7/Supporting-images-1.jpg"
alt="Hero Image"
class="h-full w-full object-cover"
style="border-radius:10px"
/>
...
>
<img
src="https://i.ibb.co/ppfv2fY/Supporting-images-2.jpg"
alt="Hero Image"
class="h-full w-full object-cover"
style="border-radius:10px"
/>
...
`,
  ...
  <table width='100%' cellpadding='0' cellspacing='0' style='max-width:700px;margin:0 auto;background-color:#FFFFFF;border-radius:8px;'>\
    <tr><td style='padding:24px;color:#111827;font-size:14px;line-height:1.6;'>\
      ...
      <h3 style='margin-top:28px;border-bottom:1px solid #E5E7EB;padding-bottom:6px;'>Action Required</h3>\
      <p>Please reply to this email with one of the following options:</p>\
...
**🤖 Approval, Release & Audit Agent is thinking…**
