localStorage.setItem(
  "demo_449923c1-9f67-486a-95b0-278face4e3d9",
  JSON.stringify([
    {
      message: "send mail with attachments",
      response: `
      ...
      apiCalls: [
        {
          ...
          bodyTemplate: `{"subject":"Outcome of Loss Mitigation Review","to":["ammshathwan@kayatech.com"],"content":"test mail with attchments","attachments": [{"filename": "Filled_2025-26 Property Statement of Values (SOV).xlsx","url": "https://docs.google.com/spreadsheets/d/18Is7dhlYGE4syFv6IrZW2pYngkofu_bE/export?format=xlsx"}]}`,
